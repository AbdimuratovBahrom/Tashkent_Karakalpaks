...
const App = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      "button",
      { className: "button next shadow", onClick: next },
      React.createElement(
        "svg",
...
const Image = ({ url, title, open, inPlace, id, onInPlace, total }) => {
  ...
  const onStateChange = () => {
    ...
    if (border.current) {
      gsap.set(
        border.current,
        Object.assign(Object.assign({}, defaults), getPosSmall())
      );
      ...
      if (open) {
        ...
        gsap
          ...
          .to(
            clip.current,
            Object.assign(
              Object.assign(Object.assign({}, defaults), getPosCenter()),
              { duration: upDuration, ease: "power3.inOut" }
            )
          )
          .to(
            clip.current,
            Object.assign(
              Object.assign(Object.assign({}, defaults), getPosEnd()),
              {
        ...
        gsap
          ...
          .set(
            clip.current,
            Object.assign(Object.assign({}, defaults), getPosStart())
          )
          .to(
            clip.current,
            Object.assign(
              Object.assign(Object.assign({}, defaults), getPosCenter()),
              { delay: delay, duration: flipDuration, ease: "power4.out" }
            )
          )
          .to(
            clip.current,
